...
create table sungjuk(
    ...
    ,kor int check(kor between 0 and 100)   -- 국어점수 0~100점 사이만 입력가능
    ,eng int check(eng between 0 and 100)   -- 영어점수 0~100점 사이만 입력가능
    ,mat int check(mat between 0 and 100)   -- 수학점수 0~100점 사이만 입력가능
...
values(1, '홍길동', -10, 20, 300);     -- 국영수 점수는 0~100점 사이만 가능
